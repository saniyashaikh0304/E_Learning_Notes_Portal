...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="shownotes.jsp">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="addAssign.jsp">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="showAssignAction.jsp">
          <i class="bi bi-envelope"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="LogoutServlet1">
